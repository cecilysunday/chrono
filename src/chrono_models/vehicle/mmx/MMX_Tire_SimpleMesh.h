...
#ifndef MMX_TIRE_SIMPLEMESH_H
#define MMX_TIRE_SIMPLEMESH_H
...
class CH_MODELS_API MMX_Tire_SimpleMesh : public MMXTire {
  public:
    MMX_Tire_SimpleMesh(const std::string& name);
