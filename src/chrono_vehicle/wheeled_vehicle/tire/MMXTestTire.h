...
#ifndef MMXTESTTIRE_H
#define MMXTESTTIRE_H
...
class CH_VEHICLE_API MMXTestTire : public ChTire {
  public:
    MMXTestTire(const std::string& name  ///< [in] name of this tire system
                );
  ...
  //private:
    ...
    /// A MMXTestTire always returns zero force and moment since tire
