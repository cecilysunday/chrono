...
#ifndef MMX_TIRE_PADDLEMESH_H
#define MMX_TIRE_PADDLEMESH_H
...
class CH_MODELS_API MMX_Tire_PaddleMesh : public MMXTire {
  public:
    MMX_Tire_PaddleMesh(const std::string& name);
